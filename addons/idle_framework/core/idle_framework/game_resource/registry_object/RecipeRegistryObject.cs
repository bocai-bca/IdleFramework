...
public partial class RecipeRegistryObject : Resource
{
	...
	/// </summary>
	[Export] public Dictionary<StringName, NumberProvider> Ingredients = new();
	...
	/// </summary>
	[Export] public NumberProvider RequiredSeconds;
	...
	/// </summary>
	/// <returns></returns>
	[Export] public Dictionary<StringName, NumberProvider> Results = new();
}